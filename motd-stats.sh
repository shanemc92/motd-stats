...
RED="${RST}$(tput setaf 196)"
GRE="${RST}$(tput setaf 46)"
YEL="${RST}$(tput setaf 226)"
BLU="${RST}$(tput setaf 33)"
MAG="${RST}$(tput setaf 201)"
CYA="${RST}$(tput setaf 51)"
WHI="${RST}$(tput setaf 231)"
BBLK="${BLD}$(tput setaf 0)"
BRED="${BLD}$(tput setaf 196)"
BGRE="${BLD}$(tput setaf 46)"
BYEL="${BLD}$(tput setaf 226)"
BBLU="${BLD}$(tput setaf 33)"
BMAG="${BLD}$(tput setaf 201)"
BCYA="${BLD}$(tput setaf 51)"
BWHI="${BLD}$(tput setaf 231)"
DGRY="${RST}\e[90m"
ORA="${RST}\e[38;5;202m"
