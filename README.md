...
- Whether to send an ntfy notification after nightly apt updates
...
and adds a nightly cron job for `apt update`. Safe to re-run — it won't duplicate
aliases, cron entries, or sudoers files.
